...
<page>
  <template v-if="applications.length > 0">
    ...
    <willow-empty-state
      ...
      :img="'https://www.premiumcreditbureau.com/wp-content/uploads/2017/02/business-application-form-1-1.png'"
      :primaryAction="{ label: 'Veiw listings', url: '/Admin/listings' }"
      :secodaryAction="{ label: 'two', url: 'Admin/buildings/New' }"
    >
    It looks like there are no applications to be found. List a unit, and wait for them to come in...
    </willow-empty-state>
  </template>
</page>
</template>
