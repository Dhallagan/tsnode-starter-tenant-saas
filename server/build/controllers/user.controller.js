...
var UserController = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userService.createUserNoVerification(res, viewModel.firstName, viewModel.lastName, viewModel.email, viewModel.password, viewModel.domain)];
    ...
    UserController.prototype.getPlan = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var errors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userService.getPlan(res, req.params.id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
